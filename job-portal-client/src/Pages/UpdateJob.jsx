...
const UpdateJob = () => {
  const { id } = useParams();
  console.log(id); //we will get id  which we want to edit when we click on edit button in consolelog
  const {
    _id,
    jobTitle,
    companyName,
    ...
    fetch(`http://localhost:3000/update-job/${id}`, {
      ...
      .then((result) => {
        ...
        if (result.acknowledged === true) {
          alert("job updated succcesfully");
        }
        reset();
      });
  };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              <input
                type="text"
                defaultValue={jobTitle} //taaki jb edit dbaye to ye job vala page khule aur default value ye likha hoex.software engineer
                {...register("jobTitle")}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="lg:w-1/2 w-full">
              ...
              >
                {/* value from job.json file */}
                <option value={emplymentType}>{emplymentType}</option>
